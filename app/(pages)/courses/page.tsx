      ...
      <div className="w-full flex justify-between mt-[34px]">
        <div>
          <div className="flex items-center gap-[55px]">
            ...
            <div
              className="flex items-center h-[24px] gap-[6px] cursor-pointer"
            ...
            <div className="flex items-center w-full mt-[24px] flex-wrap gap-[8px]">
              {categories.map((cat) => {
                ...
                return (
                  ...
                  >
                    <span className={active ? "text-white" : "text-[#525252]"}>
                      {CATEGORY_ICONS[cat.icon]}
                    </span>
                    <p
                      className={`font-medium text-[16px] leading-[24px] tracking-[0%] ${active ? "text-white" : "text-[#666666]"}`}
                    >
                      {cat.name}
                    </p>
                  </div>
